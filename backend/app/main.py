...
from app.routers import root, project_routes, stats_routes, assistants_routes, chats_routes
...
app.include_router(chats_routes.router, prefix="/api/projects/{id}/chats")