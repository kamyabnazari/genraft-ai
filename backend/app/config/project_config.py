project_config = {
    ...
    "assistants": {
        ...
        "coo": {
            "instructions": "As a COO, manage the operational strategy. Discussions should be concise, enclosed within {output_format_start}...{output_format_end}, with no more than {max_exchanges} exchanges in a thread."
        },
    }
}